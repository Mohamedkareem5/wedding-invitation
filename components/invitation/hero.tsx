  ...
  return (
    <section className="relative flex min-h-[760px] w-full flex-col items-center overflow-hidden bg-ivory-card">
      ...
      >
        <motion.p
          variants={item}
          className="font-body max-w-[280px] text-center text-[18px] leading-[1.6] text-brown-deep/90"
          dir="rtl"
        >
        ...
        <div className="mt-4 flex flex-col items-center">
          <motion.h2
            variants={item}
            className="font-display text-[52px] leading-none text-brown-deep/90 drop-shadow-sm relative z-20 mb-[25px]"
          >
            مُصْطَفَى
          </motion.h2>
          ...
          <motion.h2
            variants={item}
            className="font-display text-[52px] leading-none text-brown-deep/90 drop-shadow-sm relative z-20 mt-[25px]"
          >
            نِهَال
          </motion.h2>
        </div>
